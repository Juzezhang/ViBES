...
from utils.genmo.rotation_conversions import axis_angle_to_matrix
from utils.genmo.vis.renderer_tools import checkerboard_geometry
...
class Renderer:
    ...
    def render_with_ground_timeline(
        ...
        for t, verts in enumerate(verts_list):
            ...
            image = results[0, ..., :4].detach().cpu().numpy() * 255
