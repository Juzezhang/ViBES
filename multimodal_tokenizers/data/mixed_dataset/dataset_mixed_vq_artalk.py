...
class MixedDatasetVQArtalk(data.Dataset):
    def __init__(
        self,
        args,
        dataset_configs,
        ...
        **kwargs,
        ...
        - unit_length: Length of the motion units for data processing.
        ...
        for root, dirs, files in tqdm(os.walk(pjoin(self.data_root_tfhp, 'coef'))):
            ...
            try:
                ...
                for file in files:
                    ...
                    # Concatenate jaw pose and expressions for participant 1's face
                    face_features = np.concatenate([expressions_padded, pose], axis=1)
