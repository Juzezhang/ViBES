...
class MLM(nn.Module):
    ...
    def forward_encdec(
        ...
        face_strings, hand_strings, upper_strings, lower_strings, motion_string = self.body_token_to_string(face_token, hand_token, lower_token, upper_token, lengths)
    ...
    def forward_dec(
        ...
        face_strings, hand_strings, upper_strings, lower_strings, motion_string = self.body_token_to_string(
    ...
    def body_token_to_string(self, face_token: Tensor, hand_token: Tensor, lower_token: Tensor, upper_token: Tensor, lengths: List[int]):
        motion_string = []
        face_string = []
        hand_string = []
        upper_string = []
