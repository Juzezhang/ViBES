...
def main():
    ...
    for batch in tqdm(datasets.token_dataloader(), desc=f'compositional motion tokenize'):
        ...
        # # rec_exp_p1 = rec_face_test_p1[0, :, 12:].detach().cpu().numpy()  # First 50 dims of expression
        ...
        if show_comparison:
            ...
            audio_path = f"/simurgh/group/juze/datasets//YouTube_Talking_Synthetic/audios/{seq_name}.wav"
            ...
            start_frame= 0
            end_frame = gt_face_exp_p1.shape[0]
            pred_images = []
            for i in range(start_frame, end_frame, batch_size_visualize):
                ...
                if actual_visualize_batch_size < batch_size_visualize:
            ...
            output_dir_video = os.path.join(data_root_youtube_talking_synthetic, 'reconstructed_vs_gt')
        ...
        target_path_face_p1 = os.path.join(output_dir_youtube_talking_synthetic + '.npy')
