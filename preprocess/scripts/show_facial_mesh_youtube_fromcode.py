...
parser.add_argument('--video_name', type=str, default="202008750.mp4", 
...
face_coeff_start_frame = video_start_frame
face_coeff_end_frame = video_end_frame
# Load FLAME coefficients (expression, shape, pose) for the video
...
dump_path = join(OUTPUT_DIR, f"{video_name.split('/')[0]}_{start_time}_{end_time}_fromcode.mp4")
