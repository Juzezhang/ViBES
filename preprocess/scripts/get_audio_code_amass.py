...
parser.add_argument('--wav_folder', type=str, default="/scr/juze/datasets/AMASS/audios_q", help="Path to the folder containing .wav files")
parser.add_argument('--output_dir', type=str, default="/scr/juze/datasets/AMASS/audios_q_token_glm",
...
for wav_file in tqdm(os.listdir(wav_folder)):
    ...
    if wav_file.endswith(".wav"):
        ...
        try:
            ...
            output_sub_dir = join(output_dir)
