...
parser.add_argument('--wav_folder', type=str, default="/path/to/TFHP/audios", help="Path to the folder containing .wav files")
parser.add_argument('--output_dir', type=str, default="/path/to/TFHP/audios_token_glm",
