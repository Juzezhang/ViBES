...
parser.add_argument('--seq_name', type=str, default="2e88ace6-b04e-4c21-9758-09f03b8b33b6", 
                    help='Sequence folder name')
parser.add_argument('--video_name', type=str, default="5f56b56b0fa1b412025708cf", 
                    help='Video name within the sequence')
parser.add_argument('--start_frame', type=int, default=35000, 
                    help='Starting frame index')
parser.add_argument('--end_frame', type=int, default=35500, 
...
if len(pred_images) > 0:
    ...
    dump_path = join(output_dir, f"{seq_name}_{video_name}_{start_frame}_{end_frame}.mp4")
