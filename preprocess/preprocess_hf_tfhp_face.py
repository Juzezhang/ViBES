...
- Group tokens into fixed-size chunks (26 audio + 52 face)
...
Usage:
    python preprocess_hf_tfhp_face.py \
...
def main():
    ...
    for speaker in tqdm(speakers, desc="Processing speakers"):
        ...
        for session in sessions:
            ...
            # Merge and process session fragments
            # All files from this session are merged, then grouped into fixed-size chunks
            ...
            # Create turn objects (face only version)
            # All chunks share the same conversation_id = speaker_session
