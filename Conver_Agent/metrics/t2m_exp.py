    ...
    def compute(self, sanity_flag):
        ...
        if self.text:
            ...
            for i in range(count_seq // self.R_size):
                ...
                # print(dist_mat[:5])
                dist_mat = dist_mat.float()  # convert BFloat16 to Float32
            ...
            for i in range(count_seq // self.R_size):
                ...
                dist_mat = euclidean_distance_matrix(
                    group_texts, group_motions).nan_to_num()
                # match score
                dist_mat = dist_mat.float()  # 将 BFloat16 类型转换为 Float32
        ...
        all_genmotions = all_genmotions.float()  # convert BFloat16 to Float32
        all_gtmotions = all_gtmotions.float()   # convert BFloat16 to Float32
