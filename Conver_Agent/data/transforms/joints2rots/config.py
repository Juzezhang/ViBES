...
# todo - configable
SMPL_MODEL_DIR = "./models/smpl_models/"
GMM_MODEL_DIR = "./models/smpl_models/"
SMPL_MEAN_FILE = "./models/smpl_models/neutral_smpl_mean_params.h5"
# for collsion
Part_Seg_DIR = "./models/smpl_models/smplx_parts_segm.pkl"
